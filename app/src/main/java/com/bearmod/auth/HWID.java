...
public class HWID {
    ...
    /**
     * Get hardware ID
     * @return Hardware ID as hexadecimal string (32 characters - meets 20+ requirement)
     */
    public static String getHWID() {
        String hwid = bytesToHex(generateHWID());
        // MD5 hash always produces 32 hex characters (16 bytes * 2 hex chars per byte)
        // This meets the minimum 20-character requirement
        return hwid;
    }
    ...
    public static byte[] generateHWID() {
        try {
            ...
            return hash.digest(s.getBytes(StandardCharsets.UTF_8));
