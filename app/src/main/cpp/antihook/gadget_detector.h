...
namespace BearLoader {
    namespace EnhancedAntiHook {
        ...
        private:
            ...
            bool detectFridaSymbols();
            bool detectHookModifications();
            bool detectGadgetSpecific();
            ...
            bool findStringInMemory(const std::string& searchString);
        ...
        public:
            ...
            // Callback management
            void addDetectionCallback(DetectionCallback callback);
